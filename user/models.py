...
class User(models.Model):
    ...
    card_id = models.CharField(max_length=20, default="", blank=True, unique=True, null=True)
    strn_code = models.CharField(max_length=12, default="", blank=True, unique=True, null=True)
    sams_code = models.CharField(max_length=12, default="", blank=True, unique=True, null=True)
    jupas_app_code = models.CharField(max_length=32, default="", blank=True, unique=True, null=True)
