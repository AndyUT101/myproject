...
class User(models.Model):
    ...
    strn_code = models.CharField(max_length=12, default=None, unique=True, null=True)
    sams_code = models.CharField(max_length=12, default=None, unique=True, null=True)
