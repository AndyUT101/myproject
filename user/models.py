...
class User(models.Model):
    ...
    card_id = models.CharField(max_length=20, default=None, blank=True)
    strn_code = models.CharField(max_length=12, default=None, blank=True)
    sams_code = models.CharField(max_length=12, default=None, blank=True)
    birth_date = models.DateField(auto_now=False, null=True, blank=True)
    hkid_card = models.CharField(max_length=12, default=None, blank=True)
...
class Class_assignment(models.Model):
    ...
    def __str__():
        return self.user.username + ": " + self.class_code.class_name + self.class_number
