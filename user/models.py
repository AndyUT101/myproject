...
class User(models.Model):
    ...
    card_id = models.CharField(max_length=20, default=None, blank=True, unique=True, null=True)
    strn_code = models.CharField(max_length=12, default=None, blank=True, unique=True, null=True)
    sams_code = models.CharField(max_length=12, default=None, blank=True, unique=True, null=True)
    jupas_app_code = models.CharField(max_length=32, default=None, blank=True, unique=True, null=True)
    barcode = models.CharField(max_length=32, default=None, blank=True, unique=True, null=True)
    birth_date = models.DateField(auto_now=False, null=True, blank=True)
    hkid_card = models.CharField(max_length=12, default=None, blank=True, unique=True, null=True)
